export const LAUNCHPAD_STORAGE_ADDRESS =
  process.env.LAUNCHPAD_STORAGE_ADDRESS || '0x9d340C2edBfFfB861475b8aF5F99D25B35e17D67';
...
export const QUERY_KEY = {
  ACCOUNT: 'account',
  CHECK_USER_WHITELIST: 'check_user_whitelist',
  APPROVAL_STATUS: 'approval_status',
  LAUNCHPAD_LIST: 'launchpad_list',
  LAUNCHPAD_DETAIL: 'launchpad_detail',
  USER_WALLET: 'user_wallet',
  NFT_BY_OWNER: 'nft_by_owner',
  MY_NFT: 'my_nft',
  LOCKED_NFT_BY_OWNER: 'locked_nft_by_owner',
  MY_WHITELIST_REGISTRATION: 'my_wallet_registration',
  MINTABLE_NFT: 'mintable_nft',
  WHITELIST: 'whitelist',
  WHITELISTCARD: 'whitelist_card',
