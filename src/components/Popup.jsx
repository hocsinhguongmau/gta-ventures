...
const Error = () => (
  <>
    <p className="">
      <Image src="/assets/images/not-in-whitelist.png" width={55} height={55} className="mx-auto" />
    </p>
...
export default function Popup() {
  return (
    <div className="fixed top-0 left-0 z-[9999] h-full w-full">
      ...
      <div className="absolute top-1/2 left-1/2 w-[352px] -translate-y-1/2 -translate-x-1/2 rounded-2xl bg-black py-10 text-center">
        ...
        <Success />
        <Error />
        <button className="btn-sm btn mt-5">Close</button>
      </div>
    </div>
  );
}
